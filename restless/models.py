...
def serialize(src, fields=None, related=None, include=None, exclude=None, fixup=None, filter=None):
    ...
    def subs(subsrc):
        return serialize(subsrc, fields=fields, include=include, exclude=exclude, fixup=fixup, filter=filter)
